    ...
    return (
        <div className="home w-full min-h-screen">
            <div className="w-full h-auto flex items-start justify-between lg:gap-x-32 md:gap-x-16 sm:gap-x-8 gap-x-4 relative">
                ...
                <div style={{backgroundColor:"white"}} className="w-full h-auto py-1 px-3 border-t border-t-[#1d1d1d] fixed bottom-0 left-0 lg:hidden md:hidden sm:block z-50"><MobileNav></MobileNav></div>
                <div style={{backgroundColor:"white"}} className="w-full h-auto py-1 px-3 border-b border-b-[#1d1d1d] fixed top-0 left-0 lg:hidden md:hidden sm:block z-50 bg-light"><TopNav></TopNav></div>
