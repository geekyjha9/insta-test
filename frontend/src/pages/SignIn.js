            ...
            <div className="flex w-full max-w-4xl rounded-lg overflow-hidden justify-center">
                <div className="w-full md:w-1/2 p-8 md:border-gray-300 md:rounded-lg">
                    <div className="flex flex-col items-center">
                        ...
                        <p className="text-gray-600 text-sm text-center my-5">Log in to see photos and videos from your friends</p>
                        <form className="space-y-4 w-full" onSubmit={handleSubmit}>
                            ...
                            <input
                                ...
                                className="block w-full px-4 py-2 border rounded-md text-gray-700 focus:outline-none focus:ring focus:ring-gray-100 text-sm"
                            />
                            <button type="submit" className="block w-full bg-blue-500 text-white font-semibold py-2 rounded-md focus:outline-none focus:ring focus:border-blue-300">
                               Sign In
                            </button>
                        </form>
