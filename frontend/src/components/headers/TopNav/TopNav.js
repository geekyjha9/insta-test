...
const TopNav = ({ openLogOutModal }) => {
    return (
        <div className="w-full h-auto flex items-center justify-center bg-ligh">
            <div className="relative w-full py-2 mr-5">
            ...
            <button className="bg-red-500 px-4 py-2 text-white cursor-pointer rounded hover:bg-red-600" onClick={openLogOutModal}>Logout</button>
        </div>
    )
}
