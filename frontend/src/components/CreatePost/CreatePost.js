...
import React, { useState } from 'react';
import Modal from 'react-modal';
import { uploadImage } from '../../services/awsS3.js'; // Import your S3 service function
  ...
  return (
    ...
    >
      <div className="bg-white rounded-lg p-4 md:p-6 lg:p-8 w-full max-w-md mx-4">
        ...
        <div className="mb-4">
          {selectedImage ? (
            <img src={URL.createObjectURL(selectedImage)} alt="Selected" className="w-full h-64 object-cover mb-2 rounded-md" />
          ) : (
            <div className="w-full h-64 bg-gray-200 flex items-center justify-center rounded-md">
              <label className="cursor-pointer">
                <span className="text-gray-600">Select a photo</span>
