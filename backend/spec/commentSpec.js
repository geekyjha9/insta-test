...
describe('Comment API', () => {
    ...
    describe('POST /api/posts/addComments', () => {
        it('[REQ041]_add_comment_successfully', async () => {
        ...
        it('[REQ042]_add_comment_with_invalid_token', async () => {
            const response = await request(app)
                .post('/api/posts/addComments')
    ...
    describe('GET /api/posts/getComments/:postId', () => {
        it('[REQ043]_fetch_comments_successfully', async () => {
        ...
        it('[REQ044]_fetch_comments_for_invalid_postId', async () => {
